...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--in",
        dest="in_path",
        default="./results/anal_data/gate_sample_data/gawf_gates.pt",
        type=str,
...
def main() -> None:
    ...
    if target_fg_digit is not None:
        ...
        idx_suffix = 3
    ih_path = os.path.join(args.save_dir, f"gate_ih_{idx_suffix}.{suffix}")
    hh_path = os.path.join(args.save_dir, f"gate_hh_{idx_suffix}.{suffix}")

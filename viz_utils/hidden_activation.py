...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--unit_order_path",
        type=str,
        default="./results/anal_data/hidden_activation_data/unit_order_by_cosine_similarity.npy",
...
def main() -> None:
    ...
    if raw_in_path is None or raw_in_path == "":
        raw_in_path = "./results/anal_data/hidden_activation_data"
    ...
    if args.z_mode == "row-wise":
        if os.path.isfile(tuned_order_path):
            ...
            raise FileNotFoundError(
                ...
                "Run anal_utils/analyze_gawf_hidden_activation.py on this dataset, "

...
Usage:
  python -m viz_utils.viz_metrics_best_acc_bars
  python -m viz_utils.viz_metrics_best_acc_bars --metrics_dir results/models/sector_40h_adamw
  python -m viz_utils.viz_metrics_best_acc_bars --metrics path1.json path2.json ... --out fig.png
"""
...
DEFAULT_METRICS_PATHS = [
    "results/models/sector_40h_adamw/gawf_sector_acc_h256_lr0.0005_wd0.0001_do0_fb50_metrics.json",
    "results/models/sector_40h_adamw/lstm_sector_acc_h80_lr0.0005_wd0.0001_do0_metrics.json",
    "results/models/sector_40h_adamw/gru_sector_acc_h105_lr0.0005_wd0.0001_do0_metrics.json",
    "results/models/sector_40h_adamw/rnn_sector_acc_h275_lr0.0005_wd0.0001_do0_metrics.json",
]

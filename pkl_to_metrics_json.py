...
Usage:
  # Single file
  python pkl_to_metrics_json.py results/models/sector_40h_adamw/gru_sector_acc_h105_lr0.0005_wd0.0001_do0.pkl

  # All pkl files in a directory (no _model.pth in name)
  python pkl_to_metrics_json.py results/models/sector_40h_adamw/

...
#SBATCH --output=artifacts/amarel_logs/hparam_full_grid/%A_%a.out
#SBATCH --error=artifacts/amarel_logs/hparam_full_grid/%A_%a.err
...
mkdir -p artifacts/amarel_logs/hparam_full_grid

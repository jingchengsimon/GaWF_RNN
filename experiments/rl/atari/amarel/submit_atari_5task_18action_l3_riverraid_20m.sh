#!/usr/bin/env bash
# Submit the 20M Riverraid five-task full18 L3 run for ANN/RNN/GRU/LSTM/GaWF seed 1.
...
RESULT_PARENT="$AIM3_RESULTS_PATH/data/rl/atari/5task_18action/formal_20m_4mpertask_raw_seeds_riverraid_20260914"
RUNNER="$ROOT/experiments/rl/atari/amarel/run_atari_5task_18action_l3_riverraid_20m_array.sh"
ARTIFACT_TAG="atari_5task_18action_l3_formal_20m_4mpertask_raw_seeds_riverraid_20260914_amarel72h"
ARTIFACT_ROOT="$ROOT/experiments/rl/atari/amarel/artifacts/$ARTIFACT_TAG"
RESULT_TAG="atari_dqn_5task_riverraid_fs4_stack4_l3_buf0p5m_eps5m_lrpertask2m_20m"
ARRAY_TASKS="0-24"
...
if (( DRY_RUN )); then
  ...
  echo "LR: per-task 2M-step decay; epsilon: fixed 5M global steps"
...
EXPORTS+=",LEARNING_STARTS_PER_TASK=20000,EXPLORATION_STEPS=5000000,REQUIRED_GIB=27"
